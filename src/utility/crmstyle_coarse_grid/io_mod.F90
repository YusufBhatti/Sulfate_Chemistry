...
! *****************************COPYRIGHT*******************************
!
!  Module containing derived types used for IO
...
TYPE PP_Header_type
  ...
  INTEGER :: LBUser6      = -99  ! 44          Free (formerly used by FIELDCOS)
  INTEGER :: LBUser7      = -99  ! 45          Sub-model number (UM only)
  REAL    :: BULev        = -99.0 ! 46          Upper layer boundary
  REAL    :: BHULev       = -99.0 ! 47          Upper layer boundary
  REAL    :: BRsvd(2)     = -99.0 ! 48-49       PP-Package use
  REAL    :: BDatum       = -99.0 ! 50          Datum value
  REAL    :: BAcc         = -99.0 ! 51          Packing accuracy
  REAL    :: RLevel       = -99.0 ! 52 BLEV   : Level (B or Zsea for hybrid)
  REAL    :: RefLevel     = -99.0 ! 53 BRLEV  : Reference level - lower layer bd
  REAL    :: BHLev        = -99.0 ! 54          Level (A or C for hybrid)
  REAL    :: BHRLev       = -99.0 ! 55          Lower layer boundary
  REAL    :: PseudoLat    = -99.0 ! 56 BPLAT  : Real lat of 'pseudo' N Pole
  REAL    :: PseudoLon    = -99.0 ! 57 BPLON  : Real lon of 'pseudo' N Pole
  REAL    :: bgor         = -99.0 ! 58          Grid orientation
  REAL    :: ZerothLat    = -99.0 ! 59 BZY    : Zeroth latitude
  REAL    :: LatInt       = -99.0 ! 60 BDY    : Latitude interval
  REAL    :: ZerothLon    = -99.0 ! 61 BZX    : Zeroth longitude
  REAL    :: LonInt       = -99.0 ! 62 BDX    : Longitude interval
  REAL    :: bmdi         = -99.0 ! 63          Missing data indicator
  REAL    :: bmks         = -99.0 ! 64          M.K.S. scaling factor
