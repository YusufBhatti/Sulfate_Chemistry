...
INTEGER, SAVE, ALLOCATABLE, TARGET   :: bl_index_t_l( :, : )
INTEGER, SAVE, ALLOCATABLE, TARGET   :: bl_index_t_r( :, : )
...
! Linear weights used mostly by the idealised setup
REAL, SAVE, ALLOCATABLE :: intw_w2rho(:,:)
REAL, SAVE, ALLOCATABLE :: intw_rho2w(:,:)
