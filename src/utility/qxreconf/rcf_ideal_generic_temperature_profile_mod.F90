...
! *****************************COPYRIGHT*******************************
!  Generic idealised 1D profile setup

MODULE rcf_ideal_generic_temperature_profile_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: &
  ModuleName='RCF_IDEAL_GENERIC_TEMPERATURE_PROFILE_MOD'

CONTAINS

! Subroutine rcf_ideal_generic_temperature_profile
!
! Description:
!   A simple wrapper routine to set up any temperature profiles that aren't
!   explicitly catered for by other routines, via a series of 1D profiles.
...
SUBROUTINE rcf_ideal_generic_temperature_profile ( hdr_out, xi3_at_theta,    &
...
CHARACTER (LEN=*),  PARAMETER :: &
  RoutineName='RCF_IDEAL_GENERIC_TEMPERATURE_PROFILE'
...
!  Copy relevant part of extended exner array back to the actual field.
  ...
  ! Only print out the first T-P profile.
  print_profile = .FALSE.

  ! No treatment of exner_surf.
END DO
...
RETURN
END SUBROUTINE rcf_ideal_generic_temperature_profile
END MODULE rcf_ideal_generic_temperature_profile_mod
