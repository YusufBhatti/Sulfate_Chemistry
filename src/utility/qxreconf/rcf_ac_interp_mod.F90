...
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='RCF_AC_INTERP_MOD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='RCF_U_TO_P'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='RCF_V_TO_P'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='RCF_P_TO_U'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='RCF_P_TO_V'
