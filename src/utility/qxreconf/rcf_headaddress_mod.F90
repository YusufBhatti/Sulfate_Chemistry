...
INTEGER, PARAMETER :: IC_Stochastic_flag      = 29 ! Flag for presence of 
                                                   ! SP data
INTEGER, PARAMETER :: IC_stph_n1              = 30 ! First dimension of SP data
INTEGER, PARAMETER :: IC_stph_n2              = 31 ! Second dimension of SP data
INTEGER, PARAMETER :: IC_stph_seed            = 32 ! Seed for SP random number 
                                                   ! generator
