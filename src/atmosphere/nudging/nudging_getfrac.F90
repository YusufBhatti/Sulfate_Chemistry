...
!------------------------------------------------------------------
MODULE nudging_getfrac_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'NUDGING_GETFRAC_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='NUDGING_GETFRAC'
...
END MODULE nudging_getfrac_mod
