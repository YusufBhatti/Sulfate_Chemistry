...
MODULE nudging_ecmwf_to_mod_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'NUDGING_ECMWF_TO_MOD_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='NUDGING_ECMWF_TO_MOD'
      ...
      IF (PrintStatus > PrStatus_Diag  .AND.                           &
        ...
        WRITE(umMessage,'(A,4E12.5,2I6)')                              &
          'NUDGING_ECMWF_TO_MOD: Press calc uses ',                            &
           ...
           step, k, l
        CALL umPrint(umMessage,src='nudging_ecmwf_to_mod')
      END IF
...
END MODULE nudging_ecmwf_to_mod_mod
