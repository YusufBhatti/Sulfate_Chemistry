...
!------------------------------------------------------------------
MODULE nudging_calc_ecmwf_60levs_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER,                &
               PRIVATE :: ModuleName = 'NUDGING_CALC_ECMWF_60LEVS_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='NUDGING_CALC_ECMWF_60LEVS'
...
IF (file_levels /= ecmwf_nlevs) THEN
  ...
  CALL umPrint(umMessage,src='nudging_calc_ecmwf_60levs')
...
END MODULE nudging_calc_ecmwf_60levs_mod
