...
!------------------------------------------------------------------
MODULE nudging_interpolation_three_d_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER,                   &
             PRIVATE :: ModuleName = 'NUDGING_INTERPOLATION_THREE_D_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='NUDGING_INTERPOLATION_THREE_D'
...
END MODULE nudging_interpolation_three_d_mod
