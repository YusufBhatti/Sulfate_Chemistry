...
!------------------------------------------------------------------
MODULE nudging_calc_diags_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'NUDGING_CALC_DIAGS_MOD'
CONTAINS
...
SUBROUTINE nudging_calc_diags(        &
  ...
  l_calc_diag1, var_diag1,            & ! Diag - Ana data on model grid
  l_calc_diag2, var_diag2,            & ! Diag - Variable after nudging
  l_calc_diag3, var_diag3,            & ! Diag - Increm due to Nudging
  l_calc_diag4, var_diag4,            & ! Diag - Increm due to other process
  l_calc_diag5, var_diag5)              ! Diag - relaxation parameter

USE nudging_control                     ! Access Nudging Diagnostics
...
! Input - Logicals controlling output of each diagnostic
LOGICAL, INTENT(IN)  :: l_calc_diag1, l_calc_diag2,             &
  l_calc_diag3, l_calc_diag4, l_calc_diag5
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='NUDGING_CALC_DIAGS'
...
END MODULE nudging_calc_diags_mod
