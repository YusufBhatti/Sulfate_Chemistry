...
MODULE nudging_call_relax_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'NUDGING_CALL_RELAX_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='NUDGING_CALL_RELAX'
...
END MODULE nudging_call_relax_mod
