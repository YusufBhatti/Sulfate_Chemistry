...
!------------------------------------------------------------------
MODULE nudging_calc_ecmwf_91levs_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER,                  &
         PRIVATE :: ModuleName = 'NUDGING_CALC_ECMWF_91LEVS_MOD'
CONTAINS

SUBROUTINE nudging_calc_ecmwf_91levs(        &
...
USE nudging_ecmwf_91level_def           ! ECMWF pressure levels definition module
...
INTEGER, INTENT(IN) :: file_levels           ! model levels
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='NUDGING_CALC_ECMWF_91LEVS'
...
IF (file_levels /= ecmwf_nlevs) THEN
  ...
  CALL umPrint(umMessage,src='nudging_calc_ecmwf_91levs')
...
END SUBROUTINE nudging_calc_ecmwf_91levs

END MODULE nudging_calc_ecmwf_91levs_mod
