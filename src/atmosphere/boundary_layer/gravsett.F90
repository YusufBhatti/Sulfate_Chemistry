...
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'GRAVSETT_MOD'
CONTAINS
...
!                                         (vstokes corrected)
REAL :: massout2k2(pdims%i_start:pdims%i_end,                           &
                   pdims%j_start:pdims%j_end)
                                !flux falling 2 levs from lev k+2
REAL :: massout1k2(pdims%i_start:pdims%i_end,                           &
                   pdims%j_start:pdims%j_end)
                                !flux falling 1 levs from lev k+2
REAL :: massout2k1(pdims%i_start:pdims%i_end,                           &
                   pdims%j_start:pdims%j_end)
                                !flux falling 2 levs from lev k+1
REAL :: massout1k1(pdims%i_start:pdims%i_end,                           &
                   pdims%j_start:pdims%j_end)
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='GRAVSETT'
