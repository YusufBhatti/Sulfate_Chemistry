...
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='SCNSCV2_MOD'
...
REAL, INTENT(IN) ::                   &
 ...
 ,q(tdims%i_start:tdims%i_end,        & ! water vapour(kg/kg)
    tdims%j_start:tdims%j_end,        & !
                1:tdims%k_end)        & !
 ,qcl(tdims%i_start:tdims%i_end,      & ! cloud liquid water (kg/kg)
      tdims%j_start:tdims%j_end,      & !
                  1:tdims%k_end)      & !
 ,qcf(tdims%i_start:tdims%i_end,      & ! cloud ice water (kg/kg)
      tdims%j_start:tdims%j_end,      & !
                  1:tdims%k_end)      & !
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='SCNSCV2'
