...
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='DUSTBIN_CONVERSION_MOD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='CONVERT_DUST_SIX_TO_TWO'
...
p1(1:6) = (/ 0.0, 1.0, 1.0, 0.43, 0.0, 0.0 /)
p2(1:6) = (/ 0.0, 0.0, 0.0, 0.57, 1.0, 1.0 /)
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='CONVERT_DUST_TWO_TO_SIX'

IF (lhook) CALL dr_hook(ModuleName//':'//RoutineName,zhook_in,zhook_handle)

! Set p1,p2 here as setting these in the declaration enables the 'save'
! property by default. Which isn't desirable.
p1(1:6) = (/ 0.0035, 0.035, 0.220, 0.745, 0.0,     0.0 /)
p2(1:6) = (/ 0.0,     0.0,    0.0,    0.219, 0.781,  0.0 /)
