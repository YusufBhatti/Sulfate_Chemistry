...
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='SET_ARCL_DIMENSIONS_MOD'
...
! Internal model switches
!
LOGICAL, INTENT(OUT) :: l_use_arcl(npd_arcl_species)
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='SET_ARCL_DIMENSIONS'
