...
REAL, PARAMETER :: n0 = 200.0e7         ! Standard number density
                                        ! of murk (/m3)
REAL, PARAMETER :: b0= 0.14             ! Activation parameter
REAL, PARAMETER :: radius0 = 0.11e-6    ! Radius of standard murk
                                        ! particle (m)
REAL, PARAMETER :: rho_aerosol = 1700.0 ! Density of murk (kg/m3)
REAL, PARAMETER :: rho_air = 1.0        ! Density of air (kg/m3)

REAL, PARAMETER :: beta0  = 1.5 * pi    ! Scattering coefficient
                                        ! normalisation
REAL, PARAMETER :: a0 = 1.2e-9          ! Constant involving surface
                                        ! energy of water
REAL, PARAMETER :: m0 = fourthirds * pi * radius0 * radius0 * radius0   &
                        * (rho_aerosol/rho_air) * n0
                                      ! Standard aerosol mass mixing
                                      ! ratio (kg/kg)
REAL, PARAMETER :: power = 1.0/6.0      ! Murk particle radius/mass
                                        ! loading power
