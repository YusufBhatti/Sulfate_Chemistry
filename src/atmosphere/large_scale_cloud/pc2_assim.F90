...
MODULE pc2_assim_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'PC2_ASSIM_MOD'
CONTAINS
...
!      Forcing of temperature over the timestep (K)
   deltaq  (tdims%i_start:tdims%i_end,                                  &
            tdims%j_start:tdims%j_end,                                  &
                        1:tdims%k_end),                                 &
!      Forcing of vapour (kg kg-1)
   deltaqcl(tdims%i_start:tdims%i_end,                                  &
            tdims%j_start:tdims%j_end,                                  &
                        1:tdims%k_end),                                 &
!      Forcing of liquid (kg kg-1)
   deltaqcf(tdims%i_start:tdims%i_end,                                  &
            tdims%j_start:tdims%j_end,                                  &
                        1:tdims%k_end),                                 &
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='PC2_ASSIM'
...
REAL ::                                                               &
 t_copy(      tdims%i_start:tdims%i_end,                              &
              tdims%j_start:tdims%j_end,                              &
                          1:tdims%k_end),                             &
! Copy of T
   q_copy(      tdims%i_start:tdims%i_end,                              &
                tdims%j_start:tdims%j_end,                              &
                            1:tdims%k_end)
! Copy of q
...
IF (l_pc2_homog) THEN
  ...
  CALL pc2_homog_plus_turb(p, tdims%k_end, timestep,                  &
