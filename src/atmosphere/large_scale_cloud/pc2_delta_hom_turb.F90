...
!$OMP  PARALLEL DO DEFAULT(NONE) SCHEDULE(DYNAMIC) PRIVATE(k, npt,     &
!$OMP& j, i, index_npt, t_c, tl_c, p_c, qsl_t, qsl_tl, alpha, al,      &
!$OMP& alpha_p, sd, cfl_to_m, sky_to_m, g_mqc, dqcdt, qc, dbsdtbs,     &
!$OMP& c_1, deltal)                                                    &
!$OMP& SHARED(tdims,cfl,t,lcrcp,qcl,p_theta_levels,l_mixing_ratio,     &
!$OMP&    repsilon,r,q,dqin,dtin,dpdt,dqclin,dbsdtbs0,dbsdtbs1,        &
!$OMP&    timestep,dcflpc2,l_fixbug_pc2_qcl_incr,l_fixbug_pc2_mixph,   &
!$OMP&    dcfpc2,cf,cff,dqclpc2,dqpc2,dtpc2,l_new_qsat_lsc)
