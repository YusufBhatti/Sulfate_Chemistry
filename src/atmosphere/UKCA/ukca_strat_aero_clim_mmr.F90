...
!
! ---------------------------------------------------------------------
MODULE ukca_strat_aero_clim_mmr_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: &
  ModuleName = 'UKCA_STRAT_AERO_CLIM_MMR_MOD'
...
REAL, PARAMETER   :: rho_aero= 1700.0  ! sulphuric acid density [kg m-3]
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='UKCA_STRAT_AERO_CLIM_MMR'
...
vdclim(:,:,:) = so4_reff(:,:,:)*so4_sa(:,:,:)*revert / 3.0
...
END MODULE ukca_strat_aero_clim_mmr_mod
