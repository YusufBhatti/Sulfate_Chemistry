...
! ---------------------------------------------------------------------
!
MODULE ukca_interp_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'UKCA_INTERP_MOD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='UKCA_INTERP'
