...
!  number of species is modelled. Trace gas MMrs are taken from the UM/gui.
!
!
!
...
IF (first) THEN
  ...
  IF (PrintStatus >= PrStatus_Oper) THEN
    WRITE(umMessage,*) 'UM PRESCRIBED CH4      = ',um_ch4_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED N2O      = ',um_n2o_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED CO2      = ',um_co2_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED CFC11    = ',um_cfc11_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED CFC12    = ',um_cfc12_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED CFC113   = ',um_cfc113_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED CFC114   = ',um_cfc114_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED CFC115   = ',um_cfc115_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED CCl4     = ',um_ccl4_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED MeCCl3   = ',um_meccl3_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED HCFC22   = ',um_hcfc22_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED HCFC141b = ',um_hcfc141b_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED HCFC142b = ',um_hcfc142b_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED H1211    = ',um_h1211_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED H1202    = ',um_h1202_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED H1301    = ',um_h1301_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED H2402    = ',um_h2402_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED MeBr     = ',um_mebr_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED MeCl     = ',um_mecl_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED CH2Br2   = ',um_ch2br2_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,*) 'UM PRESCRIBED H2       = ',um_h2_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
    WRITE(umMessage,'(A,E12.3)') 'UM PRESCRIBED COS      = ', &
        um_cos_for_ukca
    CALL umPrint(umMessage,src='ukca_scenario_prescribed')
  END IF
  first = .FALSE.
