...
! ---------------------------------------------------------------------
!
MODULE ukca_calc_noy_zmeans_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'UKCA_CALC_NOY_ZMEANS_MOD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='UKCA_CALC_NOY_ZMEANS'
...
END MODULE ukca_calc_noy_zmeans_mod
