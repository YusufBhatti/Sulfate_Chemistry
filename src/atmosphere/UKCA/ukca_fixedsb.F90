...
MODULE ukca_fixedsb_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'UKCA_FIXEDSB_MOD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='UKCA_FIXEDSB'
