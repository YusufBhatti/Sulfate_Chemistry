...
MODULE rad_degrade_mask_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'RAD_DEGRADE_MASK_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='RAD_DEGRADE_MASK'
...
END MODULE rad_degrade_mask_mod
