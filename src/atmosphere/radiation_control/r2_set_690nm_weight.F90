...
!- ---------------------------------------------------------------------
MODULE r2_set_690nm_weight_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'R2_SET_690NM_WEIGHT_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='R2_SET_690NM_WEIGHT'
...
END MODULE r2_set_690nm_weight_mod
