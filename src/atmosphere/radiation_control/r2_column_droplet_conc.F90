...
!- ---------------------------------------------------------------------
MODULE r2_column_droplet_conc_mod

IMPLICIT NONE

CHARACTER(LEN=*),                                                 &
    PARAMETER, PRIVATE :: ModuleName = 'R2_COLUMN_DROPLET_CONC_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='R2_COLUMN_DROPLET_CONC'
...
END MODULE r2_column_droplet_conc_mod
