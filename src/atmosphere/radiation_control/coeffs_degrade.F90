...
MODULE coeffs_degrade_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'COEFFS_DEGRADE_MOD'
CONTAINS

SUBROUTINE coeffs_degrade(es_space_interp, land, first_row,       &
                          last_row, at_top_of_lpg, at_base_of_lpg,&
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='COEFFS_DEGRADE'
