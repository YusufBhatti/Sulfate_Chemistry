...
MODULE lsp_focwwil_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'LSP_FOCWWIL_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='LSP_FOCWWIL'
