...
!----------------------------------------------------------------------
MODULE r2_set_uv_weight_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'R2_SET_UV_WEIGHT_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='R2_SET_UV_WEIGHT'
...
END MODULE r2_set_uv_weight_mod
