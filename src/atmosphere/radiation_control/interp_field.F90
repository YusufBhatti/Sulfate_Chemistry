...
MODULE interp_field_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'INTERP_FIELD_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='INTERP_FIELD'
