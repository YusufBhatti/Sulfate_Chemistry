...
!- ---------------------------------------------------------------------
MODULE r2_set_aero_clim_hadcm3_mod

IMPLICIT NONE

CHARACTER(LEN=*),                                                  &
      PARAMETER, PRIVATE :: ModuleName = 'R2_SET_AERO_CLIM_HADCM3_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='R2_SET_AERO_CLIM_HADCM3'
...
END MODULE r2_set_aero_clim_hadcm3_mod
