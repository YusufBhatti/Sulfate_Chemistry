...
MODULE dts_deduce_thetaandqv_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'DTS_DEDUCE_THETAANDQV_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='DTS_DEDUCE_THETAANDQV'
...
END MODULE dts_deduce_thetaandqv_mod
