...
!
MODULE parcel_4a5a_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'PARCEL_4A5A_MOD'
CONTAINS
...
USE cloud_w_4a5a_mod, ONLY: cloud_w_4a5a
USE detrain_4a5a_mod, ONLY: detrain_4a5a
USE term_con_4a5a_mod, ONLY: term_con_4a5a
IMPLICIT NONE
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='PARCEL_4A5A'
!----------------------------------------------------------------------
