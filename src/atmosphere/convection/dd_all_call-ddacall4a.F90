...
!
MODULE dd_all_call_4a5a_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'DD_ALL_CALL_4A5A_MOD'
CONTAINS
...
USE dd_init_mod, ONLY: dd_init
USE downd_4a5a_mod, ONLY: downd_4a5a
USE flx_init_4a5a_mod, ONLY: flx_init_4a5a
USE layer_dd_4a5a_mod, ONLY: layer_dd_4a5a
IMPLICIT NONE
...
REAL, INTENT(INOUT) ::      &
 ...
 ,dt_dd(npnts,klev+1)       & ! dT/dt from DD (K/s)
 ,dq_dd(npnts,klev+1)       & ! dq/dt from DD (kg/kg/s)
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='DD_ALL_CALL_4A5A'
...
END MODULE dd_all_call_4a5a_mod
