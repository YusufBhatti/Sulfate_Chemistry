...
!
MODULE deep_turb_grad_stress_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'DEEP_TURB_GRAD_STRESS_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='DEEP_TURB_GRAD_STRESS'
...
END MODULE deep_turb_grad_stress_mod
