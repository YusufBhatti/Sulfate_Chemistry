...
!
MODULE thp_det_4a5a_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'THP_DET_4A5A_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='THP_DET_4A5A'
