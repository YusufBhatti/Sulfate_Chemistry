...
!
MODULE flx_init_4a5a_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'FLX_INIT_4A5A_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='FLX_INIT_4A5A'
