...
!
MODULE term_con_4a5a_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'TERM_CON_4A5A_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='TERM_CON_4A5A'
...
DO i=1,npnts
  ...
  IF (.NOT. bterm(i)) THEN
    ! Depending on whether option has been chosen in namelist, either use
