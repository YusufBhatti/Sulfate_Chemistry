...
!
MODULE layer_dd_4a5a_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'LAYER_DD_4A5A_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='LAYER_DD_4A5A'
