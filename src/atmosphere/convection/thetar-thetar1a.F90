...
MODULE thetar_4a5a_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'THETAR_4A5A_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='THETAR_4A5A'
...
IF ( l_new_qsat_conv ) THEN
  CALL qsat_new(xsqr,tt,pk,npnts)
ELSE
  ! DEPENDS ON: qsat
