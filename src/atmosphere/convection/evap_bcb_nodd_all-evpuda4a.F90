...
!
MODULE evap_bcb_nodd_all_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'EVAP_BCB_NODD_ALL_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='EVAP_BCB_NODD_ALL'
...
END MODULE evap_bcb_nodd_all_mod
