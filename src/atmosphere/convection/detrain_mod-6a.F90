...
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='DETRAIN_6A_MOD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='DETRAIN_6A'
...
CALL thetar_6a (npnts, exk, exkp1, pk, pkp1, thek, thekp1, qek, qekp1,    &
