...
REAL :: frac_icekp1       ! Fraction of ice water at level k+1
REAL :: frac_liqkp1       ! Fraction of liquid water at level k+1
REAL :: tmp_dqcfekp1      ! Storage space for ice condensate rate at level k+1
REAL :: tmp_dqclekp1      ! Storage space for liquid condensate rate, level k+1
...
IF (l_q_interact) THEN
  DO i=1,npnts
    ...
    !-----------------------------------------------------------------------
     ...
     frac_icekp1   = (thekp1(i)*exkp1(i)-starticeTKelvin) /           &
...
! (and associated correction to temperatures).
    ...
    ELSE
      ...
      frac_icek   = (thek(i)*exk(i)-starticeTKelvin)/             &
             (alliceTdegC-(starticeTKelvin-tm))
