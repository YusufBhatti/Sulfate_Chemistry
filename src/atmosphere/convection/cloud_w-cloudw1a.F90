...
MODULE cloud_w_4a5a_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'CLOUD_W_4A5A_MOD'
CONTAINS
...
USE con_rad_4a5a_mod, ONLY: con_rad_4a5a
IMPLICIT NONE
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='CLOUD_W_4A5A'
