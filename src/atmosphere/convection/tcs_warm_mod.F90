...
IF (model_type == mt_single_column) THEN
  ...
  sname = 'zcld'
  lname = 'depth of cloud layer'
  units = 'm'
  Tmpscm2d  = RESHAPE( scales%zcld, [ScmRowLen,ScmRow] )
  CALL scmoutput(Tmpscm2d,TRIM(sname),TRIM(lname),units,    &
  ...
  units='-'
  TmpScm3d = RESHAPE( sim%fw_func, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)

  sname='g_func'
  lname='Mass flux similarity function, G'
  units='-'
  TmpScm3d = RESHAPE( sim%g_func, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  units='-'
  TmpScm3d = RESHAPE( sim%k_func, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  lname=TRIM(sname)
  units='-'
  TmpScm3d = RESHAPE( sim%f0_func, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  lname=TRIM(sname)
  units='-'
  TmpScm3d = RESHAPE( sim%f1_func, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  lname=TRIM(sname)
  units='-'
  TmpScm3d = RESHAPE( sim%ftheta_func, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  lname=TRIM(sname)
  units='-'
  TmpScm3d = RESHAPE( sim%k_func_rho, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  lname=TRIM(sname)
  units='-'
  TmpScm3d = RESHAPE( sim%fng_func_rho, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  lname=TRIM(sname)
  units='-'
  TmpScm3d = RESHAPE( sim%b_func_rho, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  lname=TRIM(sname)
  units='-'
  TmpScm3d = RESHAPE( sim%fw_func_rho, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  lname=TRIM(sname)
  units='-'
  TmpScm3d = RESHAPE( sim%g_func_rho, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  lname=TRIM(sname)
  units='-'
  TmpScm3d = RESHAPE( sim%fql_func_rho, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  lname=TRIM(sname)
  units='-'
  TmpScm3d = RESHAPE( sim%gql_func_rho, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)

  !  cloud base fluxes etc
  Tmpscm2d = RESHAPE( scales%mb, [ScmRowLen,ScmRow] )
  sname='mb_cb'
  ...
  Tmpscm2d = RESHAPE( scales%mb_new, [ScmRowLen,ScmRow] )
  sname='mb_new_cb'
  ...
  Tmpscm2d = RESHAPE( scales%wstar_up, [ScmRowLen,ScmRow] )
  sname='wstar_up'
  lname='wstar_up'
  units='m/s'
  CALL scmoutput(Tmpscm2d,TRIM(sname),TRIM(lname),units,    &
  ...
  Tmpscm2d = RESHAPE( cb%theta *                                    &
         (1.0+cb%q_mix*recip_epsilon)/(1.0+cb%q_mix) -cb_m1%theta*  &
         (1.0+cb_m1%q_mix*recip_epsilon)/(1.0+cb_m1%q_mix),         &
                      [ScmRowLen,ScmRow] )
  sname='dthetav_cb'
  ...
  Tmpscm2d = RESHAPE( wthetal_cb+c_virtual*cb_m1%theta*wqt_cb,   &
                      [ScmRowLen,ScmRow] )
  sname='wthetavl_m_cb'
  lname='wthetavl on lower side of cloud base'
  units='Km/s'
  CALL scmoutput(Tmpscm2d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_point,default_streams,'',routinename)
  ...
  sname='wthetavl'
  lname='wthetavl  on model levels'
  units='K m/s '
  TmpScm3d = RESHAPE( wthetavl, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
  ...
  sname='wh'
  lname='wh  on model levels'
  units='K m/s '
  TmpScm3d = RESHAPE( wh, [ScmRowLen,ScmRow,nlev+1], PAD=[0.0] )
  CALL scmoutput(TmpScm3d,TRIM(sname),TRIM(lname),units,    &
    t_inst,d_wet,default_streams,'',routinename)
