...
REAL, ALLOCATABLE ::               &
  theta_incr_diag_conv(:,:,:)      & ! potential temperature inc for conv
...
REAL, ALLOCATABLE ::               &
  dt_dd(:,:,:)                     & ! Temperature increment from DD  (K/s)
 ,dq_dd(:,:,:)                     & ! water vapour increment from DD (kg/kg/s)
 ,du_dd(:,:,:)                     & ! du/dt from DD (m/s/s)
 ,dv_dd(:,:,:)                     & ! dv/dt from DD (m/s/s)
 ,area_ud(:,:,:)                   & ! updraught fractional area
 ,area_dd(:,:,:)                     ! downdraught fractional area
...
REAL, ALLOCATABLE ::      &
 ...
 ,w2p(:,:,:)                ! (Parcel vertical velocity)^2, [(m/s)^2]
