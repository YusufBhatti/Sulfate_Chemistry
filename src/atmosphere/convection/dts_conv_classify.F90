...
MODULE dts_conv_classify_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'DTS_CONV_CLASSIFY_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='DTS_CONV_CLASSIFY'
...
END MODULE dts_conv_classify_mod
