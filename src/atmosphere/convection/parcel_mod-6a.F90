...
CALL term_con_6a(npnts,nlev,k,flxkp1,flx_init,deltak,bterm)
...
DO i=1,npnts
  ...
  ELSE
    ...
    IF (ABS(qclpkp1(i))  <   1.0e-18) qclpkp1(i) = 0.0
    IF (ABS(qcfpkp1(i))  <   1.0e-18) qcfpkp1(i) = 0.0
