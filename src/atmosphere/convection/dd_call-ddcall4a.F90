...
!
MODULE dd_call_4a5a_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'DD_CALL_4A5A_MOD'
CONTAINS
...
REAL, INTENT(INOUT) ::      &
 ...
 ,dt_dd(npnts,kct+1)        & ! dt/dt from DD (K/s)
 ,dq_dd(npnts,kct+1)          ! dq/dt from DD (kg/kg/s)
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='DD_CALL_4A5A'
