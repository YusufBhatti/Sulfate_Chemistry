...
!
MODULE evap_bcb_nodd_mod

IMPLICIT NONE

CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'EVAP_BCB_NODD_MOD'
CONTAINS
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='EVAP_BCB_NODD'
