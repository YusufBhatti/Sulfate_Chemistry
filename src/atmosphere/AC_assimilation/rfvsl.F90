...
!     SUBROUTINE RFVSL
!     RECURSIVE FILTER - VARIABLE COEFF - FOR A SCALAR LTD.AREA FIELD
!     DOCUMENTATION:
...
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='RFVSL_MOD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='RFVSL'
