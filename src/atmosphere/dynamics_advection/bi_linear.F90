...
CHARACTER(LEN=*), PARAMETER :: RoutineName='BI_LINEAR'
...
DO k = 1, dim_k_out
  DO j = 1, dim_j_out
    DO i = 1, dim_i_out
      ...
      Data_out (i,j,k) = (1.0-weight_lambda(i,j,k)) *           &
           (1.0-weight_phi(i,j,k)) *                            &
           Data_in (i_out(i,j,k),j_out(i,j,k),1)               &
           + weight_lambda(i,j,k) * (1.0-weight_phi(i,j,k))     &
           * Data_in (i_out(i,j,k)+1,j_out(i,j,k),1)           &
           + (1.0-weight_lambda(i,j,k)) * weight_phi(i,j,k)     &
