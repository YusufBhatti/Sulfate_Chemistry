...
REAL,    INTENT(INOUT) :: q(rimwidth,tdims_l%k_start:tdims_l%k_end)
REAL,    INTENT(INOUT) :: qcl(rimwidth,tdims_l%k_start:tdims_l%k_end)
REAL,    INTENT(INOUT) :: qcf(rimwidth,tdims_l%k_start:tdims_l%k_end)
REAL,    INTENT(INOUT) :: qcf2(rimwidth,tdims_l%k_start:tdims_l%k_end)
REAL,    INTENT(INOUT) :: qr(rimwidth,tdims_l%k_start:tdims_l%k_end)
REAL,    INTENT(INOUT) :: qgr(rimwidth,tdims_l%k_start:tdims_l%k_end)
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='CONVERT_LBCS'
