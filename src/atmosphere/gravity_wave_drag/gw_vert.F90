...
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'GW_VERT_MOD'
CONTAINS
...
USE gw_satn_mod, ONLY: gw_satn
USE gw_wake_mod, ONLY: gw_wake
IMPLICIT NONE
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='GW_VERT'
