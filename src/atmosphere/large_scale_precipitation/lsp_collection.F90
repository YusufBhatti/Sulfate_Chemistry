...
IF (l_psd_2) THEN
  ...
  CALL lsp_moments(points,rho,t,qcf2,cficei,zero,m_0)
  CALL lsp_moments(points,rho,t,qcf2,cficei,one,m_1)
  CALL lsp_moments(points,rho,t,qcf2,cficei,two,m_2)
  ...
  ELSE
    ...
    CALL lsp_moments(points,rho,t,qcf2,cficei,cx(182),m_bic_dic)
...
DO i = 1, points
  ...
  IF (qcf1(i)  >   m0 .AND. qcf2(i)  >   m0                                   &
    ...
    IF (l_psd_2) THEN
      ...
      ELSE
        ...
        ELSE
          ...
          vi2(i) = constp(182) * corr(i) * m_bic_dic(i)                       &
              / (rho(i) * qcf1(i) * cficei(i))
        END IF
      END IF
    ELSE
    ...
    END IF  ! l_psd_2
        ...
        !-----------------------------------------------
    fv1(i) = MAX(ABS(vi1(i)-vi2(i)),(vi1(i)+vi2(i))/8.0_real_lsprec)
    ...
    END IF  ! l_psd_2
        ...
        ! Calculate transfer
        !------------------------------------------------
    collision_eff(i) = 0.02_real_lsprec*EXP(0.08_real_lsprec*(t(i)-zerodegc))
