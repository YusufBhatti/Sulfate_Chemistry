...
REAL (KIND=prec), PARAMETER::                                               &
  a(10) = (/ 5.065339_prec,-0.062659_prec,-3.032362_prec,0.029469_prec,     &
            -0.000285_prec, 0.312550_prec, 0.000204_prec,0.003199_prec,     &
             0.000000_prec,-0.015952_prec /)
REAL (KIND=prec), PARAMETER::                                               &
  b(10) = (/ 0.476221_prec,-0.015896_prec, 0.165977_prec, 0.007468_prec,    &
            -0.000141_prec, 0.060366_prec, 0.000079_prec, 0.000594_prec,    &
             0.000000_prec,-0.003577_prec /)
...
ELSE
  ...
  DO i = 1, points
    ...
    IF (qcf(i) > smallnum) THEN
      ...
      an_out(i) = 10.0_prec**(log10_an_out(i))
