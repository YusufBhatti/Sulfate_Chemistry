...
REAL, PARAMETER :: auto_graup_qcf_thresh = 3.0e-4
...
REAL, PARAMETER :: half_range = (max_drop - min_drop_alt) / 2.0
...
REAL :: eta_before_taper

INTEGER :: level_peak           ! level of eta_peak
INTEGER :: level_surf           ! level of eta_surf

REAL :: vala_fac1, vala_fac2    ! constants for drop taper formula
