...
REAL, ALLOCATABLE :: dbz_tot(:,:,:) ! Total reflectivity (dBZ)
REAL, ALLOCATABLE :: dbz_g(:,:,:)   ! Graupel reflectivity (dBZ)
REAL, ALLOCATABLE :: dbz_i(:,:,:)   ! Ice Agg. reflectivity (dBZ)
REAL, ALLOCATABLE :: dbz_i2(:,:,:)  ! Ice Cry. reflectivity (dBZ)
REAL, ALLOCATABLE :: dbz_l(:,:,:)   ! Cloud liquid reflectivity (dBZ)
REAL, ALLOCATABLE :: dbz_r(:,:,:)   ! Rain reflectivity (dBZ)
