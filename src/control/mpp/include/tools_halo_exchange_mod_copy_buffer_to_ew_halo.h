! -- begin tools_halo_exchange_mod_copy_buffer_to_ew_halo.h --
! *****************************COPYRIGHT*******************************
...
!$OMP SHARED(levels, js, je, halo_x, field, disp_x, buffer)
DO k=1,levels
  DO j=js,je
    DO i=1,halo_x
      
      field(i+disp_x,j,k)= buffer(i,j,k)
...
! -- end  tools_halo_exchange_mod_copy_buffer_to_ew_halo.h --
