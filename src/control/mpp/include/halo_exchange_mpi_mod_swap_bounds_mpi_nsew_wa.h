! -- begin halo_exchange_mpi_mod_swap_bounds_mpi_nsew_wa.h --
! *****************************COPYRIGHT*******************************
...
CALL begin_swap_bounds_mpi_nsew_wa(               &
...
CALL end_swap_bounds_mpi_nsew_wa(                 &
  field, row_length, rows, levels,                & 
  halo_x,halo_y,                                  & 
  field_type, l_vector,                           & 
  do_east_arg, do_west_arg,                       & 
...
! -- end halo_exchange_mpi_mod_swap_bounds_mpi_nsew_wa.h --
