...
DO i = 1-halo_i, global_row_length+halo_i-1
  glob_rdxi1_p(i) = 1.0/( glob_xi1_p(i+1) - glob_xi1_p(i) )
END DO

DO i = -halo_i, global_row_length+halo_i-1
  glob_rdxi1_u(i) = 1.0/( glob_xi1_u(i+1) - glob_xi1_u(i) )
END DO

DO i = 1-halo_j, global_rows+halo_j-1
  glob_rdxi2_p(i) = 1.0/( glob_xi2_p(i+1) - glob_xi2_p(i) )
END DO

DO i = -halo_j, global_rows+halo_j-1
  glob_rdxi2_v(i) = 1.0/( glob_xi2_v(i+1) - glob_xi2_v(i) )
END DO
