...
IMPLICIT NONE
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='ALLOC_GRID_MOD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='ALLOC_GRID'
...
ALLOCATE( csxi1_p(pdims%i_start:pdims%i_end),                         &
          csxi1_u(udims%i_start:udims%i_end),                         &
          csxi2_p(pdims_l%j_start:pdims_l%j_end),                     &
          csxi2_v(vdims_l%j_start:vdims_l%j_end),                     &
          snxi1_p(pdims%i_start:pdims%i_end),                         &
          snxi1_u(udims%i_start:udims%i_end),                         &
...
ALLOCATE( cell_area_surface(pdims%i_start:pdims%i_end,                &
