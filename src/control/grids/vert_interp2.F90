...
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='VERT_INTERP2_MOD'

CONTAINS

SUBROUTINE vert_interp2                                                        &
  ( data_in, row_length, data_rows, data_levels, desired_p                     &
  , halo_x1, halo_y1, halo_x2, halo_y2, p_at_data, interp_order, data_out )
...
CHARACTER(LEN=*), PARAMETER :: RoutineName = 'VERT_INTERP2'
