...
SUBROUTINE printsub (points, title, istep, iday, t, q, dt, dq)
...
REAL ::                   &
  q(points,model_levels)  &! Specific humidity (kg/kg)
, t(points,model_levels)  &! Temperature (K)
, dt(points,model_levels) &! Temperature increment(K)
, dq(points,model_levels)  ! Specific humidity increment (kg/kg)
...
DO l=1, points
  ...
  WRITE (11,'(A33,I3)') '0 Number of atmospheric levels = ', model_levels
  ...
  WRITE (11,'(A39,I3)')                                                 &
    '0 Number of moist atmospheric levels = ', model_levels
