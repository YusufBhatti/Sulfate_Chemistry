...
USE scm_utils, ONLY: rmdi, imdi, z_th, z_rh

USE s_interp_mod, ONLY: interp1d

USE planet_constants_mod,  ONLY: cp, r, kappa, p_zero, recip_kappa
...
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='MCC_DATA'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='GET_MCC'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='ALLOC_MCC'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='DEALLOC_MCC'
