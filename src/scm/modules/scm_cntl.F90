...
, l_scmdiag_mlsnow   &! Multilayer snow      - default false
, l_scmdiag_forc     &! Forcing              - default false
, l_scmdiag_incs     &! Increments           - default false
, l_scmdiag_convss    ! Extra convection diagnostics for every conv sub-step
...
!----------------------------------------------------------------------
! The DIAGS namelist
! This is read from the forcing namelist. 
