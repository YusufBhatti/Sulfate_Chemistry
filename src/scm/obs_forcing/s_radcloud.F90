...
USE s_maxdim,  ONLY:                                       &
  mx_rw_lng, mx_rw, mx_mod_lv

USE scm_utils, ONLY:                                       &
  rmdi, imdi, rw_lng, rw, nml_nmod_lv, z_th, z_rh          &
...
, qcl_rad         (mx_rw_lng*mx_rw*mx_mod_lv) = rmdi &
, qcf_rad         (mx_rw_lng*mx_rw*mx_mod_lv) = rmdi &
, layer_cloud_rad (mx_rw_lng*mx_rw*mx_mod_lv) = rmdi
...
!=============================================================================
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='S_RADCLOUD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='READ_RADCLOUD'
...
IF (istatus /= 0) THEN
  ...
  CALL umPrint(umMessage,src='s_radcloud')
...
ELSE
  ...
  IF (layer_cloud_rad(1) /= rmdi)                                         &
    scm_layer_cloud_rad = RESHAPE( layer_cloud_rad                        &
                                 , (/rw_lng,rw,model_levels/) )

  IF (qcl_rad(1) /= rmdi)                                                 &
    scm_qcl_rad = RESHAPE( qcl_rad, (/rw_lng,rw,model_levels/) )

  IF (qcl_rad(1) /= rmdi)                                                 &
    scm_qcf_rad = RESHAPE( qcf_rad, (/rw_lng,rw,model_levels/) )
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='INTERP_RADCLOUD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='ALLOC_RADCLOUD'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='DEALLOC_RADCLOUD'
