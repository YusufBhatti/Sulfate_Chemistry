...
!=============================================================================
CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName='S_INJULES'
...
CHARACTER(LEN=*), PARAMETER :: RoutineName='READ_INJULES'
...
IF (istatus /= 0) THEN
  CALL umPrint( ' Error opening file on unit 10 from '//routinename, &
      src='s_injules')
  CALL umPrint( ' Filename = '//TRIM(ADJUSTL(scm_nml)),src='s_injules')
  CALL umPrint( ' Icode    = '//TRIM(str(istatus)),src='s_injules')
  CALL umPrint( ' IOmsg    = '//TRIM(iomessage),src='s_injules')
END IF
