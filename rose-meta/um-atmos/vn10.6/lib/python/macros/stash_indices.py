...
STASH_SECTION_BASES_CAN_HAVE_INDEX_PREFIXES = [
    "namelist:domain", "namelist:streq", "namelist:time", "namelist:use"]
STASH_SECTION_BASE_INDEX_PREFIX_RECIPES = {
    "namelist:streq": ["%02d%03d", ("isec", "item")]}
...
class TidyStashTransform(rose.macro.MacroBase):
    ...
    def transform(self, config, meta_config=None):
        ...
        for data in get_section_new_indices(config):
            ...
            # section_base is the section minus index - e.g. namelist:domain.
    ...
    def _resolve_dupl_namelists(self, config):
        ...
        loop because namelist:streq sections can become duplicate
    ...
    def _remove_duplicate_namelist(self, config, section_base, index,
        ...
        pointer_opt = STASH_SECTION_BASES_POINTER_OPT_MAP.get(
            section_base)
        # pointer_opt is e.g. dom_name for namelist:domain sections.
        ...
        if pointer_opt is not None:
            ...
            keys_nodes.sort(lambda x, y:
                            rose.config.sort_settings(x[0][0],
                                                      y[0][0]))
            # Loop through to find namelist:streq sections using this profile.
...
"""
    ...
    TEST_TRANSFORM_KEEP_CONFIG_STRING = """# domain(1) (=2)
[namelist:domain(identical1_ed6e1b5e)]
dom_name='identical1'
imn=0

# domain(2) (=1)
[namelist:domain(identical2_ed6e1b5e)]
dom_name='identical2'
imn=0

# domain(3)
[namelist:domain(normal1_4ccb4417)]
dom_name='normal1'
imn=1
imsk=1

# domain(4)
[namelist:domain(normal2_2af126ec)]
dom_name='normal2'
imn=1
imsk=2
...
# time(1), user-ignored
[!namelist:time(normal1_16055de9)]
iend=9
tim_name='normal1'

# time(2)
[namelist:time(normal2_47fd949e)]
iend=8
tim_name='normal2'

# use(1) (=2)
[namelist:use(identical1_54db5261)]
iunt=60
use_name='identical1'

# use(2) (=1)
[namelist:use(identical2_54db5261)]
iunt=60
use_name='identical2'

# use(3)
[namelist:use(normal1_39bbfabd)]
!iunt=60
use_name='normal1'
"""
    ...
    namelist:domain(1)=None=None
        Renamed to namelist:domain(identical1_ed6e1b5e)
    namelist:domain(identical1_ed6e1b5e)=None=None
        Renamed from namelist:domain(1)
    namelist:domain(identical1_ed6e1b5e)=dom_name='identical1'
        Renamed from namelist:domain(1)=dom_name
    namelist:domain(identical1_ed6e1b5e)=imn=0
        Renamed from namelist:domain(1)=imn
    namelist:domain(2)=None=None
        Renamed to namelist:domain(identical2_ed6e1b5e)
    namelist:domain(identical2_ed6e1b5e)=None=None
        Renamed from namelist:domain(2)
    namelist:domain(identical2_ed6e1b5e)=dom_name='identical2'
        Renamed from namelist:domain(2)=dom_name
    namelist:domain(identical2_ed6e1b5e)=imn=0
        Renamed from namelist:domain(2)=imn
    namelist:domain(3)=None=None
        Renamed to namelist:domain(normal1_4ccb4417)
    namelist:domain(normal1_4ccb4417)=None=None
        Renamed from namelist:domain(3)
    namelist:domain(normal1_4ccb4417)=imsk=1
        Renamed from namelist:domain(3)=imsk
    namelist:domain(normal1_4ccb4417)=dom_name='normal1'
        Renamed from namelist:domain(3)=dom_name
    namelist:domain(normal1_4ccb4417)=imn=1
        Renamed from namelist:domain(3)=imn
    namelist:domain(4)=None=None
        Renamed to namelist:domain(normal2_2af126ec)
    namelist:domain(normal2_2af126ec)=None=None
        Renamed from namelist:domain(4)
    namelist:domain(normal2_2af126ec)=imsk=2
        Renamed from namelist:domain(4)=imsk
    namelist:domain(normal2_2af126ec)=dom_name='normal2'
        Renamed from namelist:domain(4)=dom_name
    namelist:domain(normal2_2af126ec)=imn=1
    ...
    namelist:streq(1)=None=None
        Renamed to namelist:streq(00002_94eb9a06)
    namelist:streq(00002_94eb9a06)=None=None
        Renamed from namelist:streq(1)
    namelist:streq(00002_94eb9a06)=package='foo'
        Renamed from namelist:streq(1)=package
    namelist:streq(00002_94eb9a06)=tim_name='normal1'
        Renamed from namelist:streq(1)=tim_name
    namelist:streq(00002_94eb9a06)=use_name='identical1'
        Renamed from namelist:streq(1)=use_name
    namelist:streq(00002_94eb9a06)=dom_name='identical2'
        Renamed from namelist:streq(1)=dom_name
    namelist:streq(00002_94eb9a06)=isec=0
        Renamed from namelist:streq(1)=isec
    namelist:streq(00002_94eb9a06)=item=2
        Renamed from namelist:streq(1)=item
    namelist:streq(2)=None=None
        Renamed to namelist:streq(00002_8f159890)
    namelist:streq(00002_8f159890)=None=None
        Renamed from namelist:streq(2)
    namelist:streq(00002_8f159890)=package='foo'
        Renamed from namelist:streq(2)=package
    namelist:streq(00002_8f159890)=tim_name='normal1'
        Renamed from namelist:streq(2)=tim_name
    namelist:streq(00002_8f159890)=use_name='identical2'
        Renamed from namelist:streq(2)=use_name
    namelist:streq(00002_8f159890)=dom_name='identical1'
        Renamed from namelist:streq(2)=dom_name
    namelist:streq(00002_8f159890)=isec=0
        Renamed from namelist:streq(2)=isec
    namelist:streq(00002_8f159890)=item=2
        Renamed from namelist:streq(2)=item
    namelist:streq(3)=None=None
        Renamed to namelist:streq(05011_f4c34d08)
    namelist:streq(05011_f4c34d08)=None=None
        Renamed from namelist:streq(3)
    namelist:streq(05011_f4c34d08)=package='foo'
        Renamed from namelist:streq(3)=package
    namelist:streq(05011_f4c34d08)=tim_name='normal1'
        Renamed from namelist:streq(3)=tim_name
    namelist:streq(05011_f4c34d08)=use_name='identical2'
        Renamed from namelist:streq(3)=use_name
    namelist:streq(05011_f4c34d08)=dom_name='normal1'
        Renamed from namelist:streq(3)=dom_name
    namelist:streq(05011_f4c34d08)=isec=5
        Renamed from namelist:streq(3)=isec
    namelist:streq(05011_f4c34d08)=item=11
        Renamed from namelist:streq(3)=item
    namelist:streq(5)=None=None
        Renamed to namelist:streq(05011_263d8bd0)
    namelist:streq(05011_263d8bd0)=None=None
        Renamed from namelist:streq(5)
    namelist:streq(05011_263d8bd0)=package='foo'
        Renamed from namelist:streq(5)=package
    namelist:streq(05011_263d8bd0)=tim_name='normal2'
        Renamed from namelist:streq(5)=tim_name
    namelist:streq(05011_263d8bd0)=use_name='identical1'
        Renamed from namelist:streq(5)=use_name
    namelist:streq(05011_263d8bd0)=dom_name='normal2'
        Renamed from namelist:streq(5)=dom_name
    namelist:streq(05011_263d8bd0)=isec=5
        Renamed from namelist:streq(5)=isec
    namelist:streq(05011_263d8bd0)=item=11
        Renamed from namelist:streq(5)=item
    namelist:streq(d9ad6b73)=None=None
        Renamed to namelist:streq(50999_d9ad6b73)
    namelist:streq(50999_d9ad6b73)=None=None
        Renamed from namelist:streq(d9ad6b73)
    namelist:streq(50999_d9ad6b73)=package='bar'
        Renamed from namelist:streq(d9ad6b73)=package
    namelist:streq(50999_d9ad6b73)=tim_name='normal2'
        Renamed from namelist:streq(d9ad6b73)=tim_name
    namelist:streq(50999_d9ad6b73)=use_name='identical1'
        Renamed from namelist:streq(d9ad6b73)=use_name
    namelist:streq(50999_d9ad6b73)=dom_name='normal2'
        Renamed from namelist:streq(d9ad6b73)=dom_name
    namelist:streq(50999_d9ad6b73)=isec=50
        Renamed from namelist:streq(d9ad6b73)=isec
    namelist:streq(50999_d9ad6b73)=item=999
        Renamed from namelist:streq(d9ad6b73)=item
    namelist:time(1)=None=None
        Renamed to namelist:time(normal1_16055de9)
    namelist:time(normal1_16055de9)=None=None
        Renamed from namelist:time(1)
    namelist:time(normal1_16055de9)=tim_name='normal1'
        Renamed from namelist:time(1)=tim_name
    namelist:time(normal1_16055de9)=iend=9
        Renamed from namelist:time(1)=iend
    namelist:time(2)=None=None
        Renamed to namelist:time(normal2_47fd949e)
    namelist:time(normal2_47fd949e)=None=None
        Renamed from namelist:time(2)
    namelist:time(normal2_47fd949e)=tim_name='normal2'
        Renamed from namelist:time(2)=tim_name
    namelist:time(normal2_47fd949e)=iend=8
        Renamed from namelist:time(2)=iend
    namelist:use(1)=None=None
        Renamed to namelist:use(identical1_54db5261)
    namelist:use(identical1_54db5261)=None=None
        Renamed from namelist:use(1)
    namelist:use(identical1_54db5261)=iunt=60
        Renamed from namelist:use(1)=iunt
    namelist:use(identical1_54db5261)=use_name='identical1'
        Renamed from namelist:use(1)=use_name
    namelist:use(2)=None=None
        Renamed to namelist:use(identical2_54db5261)
    namelist:use(identical2_54db5261)=None=None
        Renamed from namelist:use(2)
    namelist:use(identical2_54db5261)=iunt=60
        Renamed from namelist:use(2)=iunt
    namelist:use(identical2_54db5261)=use_name='identical2'
        Renamed from namelist:use(2)=use_name
    namelist:use(3)=None=None
        Renamed to namelist:use(normal1_39bbfabd)
    namelist:use(normal1_39bbfabd)=None=None
        Renamed from namelist:use(3)
    namelist:use(normal1_39bbfabd)=iunt=60
        Renamed from namelist:use(3)=iunt
    namelist:use(normal1_39bbfabd)=use_name='normal1'
        Renamed from namelist:use(3)=use_name
stash_indices.TidyStashTransform: warnings: 5
    namelist:domain(identical2_ed6e1b5e)=None=None
        Warning: namelist:domain(identical1_ed6e1b5e) exists (identical)
    namelist:items(3)=None=None
        Cannot rename: namelist:items(97a136a1) exists (identical)
    namelist:streq(4)=None=None
        Cannot rename: namelist:streq(05011_f4c34d08) exists (identical)
    namelist:use(identical2_54db5261)=None=None
        Warning: namelist:use(identical1_54db5261) exists (identical)
    namelist:items(521d3f6c)=None=None
        Source/domain clash with namelist:items(3) will cause UM abort
""")

    TEST_TRANSFORM_CONFIG_STRING = """# domain(1) (=2)
[namelist:domain(identical1_ed6e1b5e)]
dom_name='identical1'
imn=0
...
"""
    ...
    namelist:items(521d3f6c)=source=2
        Renamed from namelist:items(2)=source
    namelist:streq(1)=None=None
        Renamed to namelist:streq(00002_c2f44d54)
    namelist:streq(00002_c2f44d54)=None=None
        Renamed from namelist:streq(1)
    namelist:streq(00002_c2f44d54)=package='foo'
        Renamed from namelist:streq(1)=package
    namelist:streq(00002_c2f44d54)=tim_name='normal1'
        Renamed from namelist:streq(1)=tim_name
    namelist:streq(00002_c2f44d54)=use_name='identical1'
        Renamed from namelist:streq(1)=use_name
    namelist:streq(00002_c2f44d54)=dom_name='identical1'
        Renamed from namelist:streq(1)=dom_name
    namelist:streq(00002_c2f44d54)=isec=0
        Renamed from namelist:streq(1)=isec
    namelist:streq(00002_c2f44d54)=item=2
        Renamed from namelist:streq(1)=item
    namelist:streq(3)=None=None
        Renamed to namelist:streq(05011_1c83d5ad)
    namelist:streq(05011_1c83d5ad)=None=None
        Renamed from namelist:streq(3)
    namelist:streq(05011_1c83d5ad)=package='foo'
        Renamed from namelist:streq(3)=package
    namelist:streq(05011_1c83d5ad)=tim_name='normal1'
        Renamed from namelist:streq(3)=tim_name
    namelist:streq(05011_1c83d5ad)=use_name='identical1'
        Renamed from namelist:streq(3)=use_name
    namelist:streq(05011_1c83d5ad)=dom_name='normal1'
        Renamed from namelist:streq(3)=dom_name
    namelist:streq(05011_1c83d5ad)=isec=5
        Renamed from namelist:streq(3)=isec
    namelist:streq(05011_1c83d5ad)=item=11
        Renamed from namelist:streq(3)=item
    namelist:streq(5)=None=None
        Renamed to namelist:streq(05011_263d8bd0)
    namelist:streq(05011_263d8bd0)=None=None
...
"""
    ...
    namelist:domain(1)=None=None
        Identical sections: namelist:domain(1) == namelist:domain(2)
    namelist:items(1)=None=None
    ...
    namelist:streq(3)=None=None
        Identical sections: namelist:streq(3) == namelist:streq(4)
    namelist:time(1)=None=None
    ...
    namelist:use(1)=None=None
        Identical sections: namelist:use(1) == namelist:use(2)
    namelist:items(2)=None=None
