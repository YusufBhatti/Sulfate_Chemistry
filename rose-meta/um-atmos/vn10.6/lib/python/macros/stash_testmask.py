                ...
                # just prognostics
                  ...
                  # l_mp_activeinsolnumber False
                    ...
                    msg = _form_msg("n24", n24,
                           "PV-tracer scheme is OFF, or called for LAM or ND")
                elif ( n24 == 2 and (not l_pv_dyn
                                     or h_global != 1)):
                    # Deactivate dyn. PV-tracer diagnostics if not requested
                    l_mask = False
                    msg = _form_msg("n24", n24,
                           "Dyn PV-tracers OFF, or called for LAM or ND")
                elif ( n24 == 3 and (not l_pv_adv_only
                                     or h_global != 1)):
                    # Deactivate dyn. PV-tracer diagnostics if not requested
                    l_mask = False
                    msg = _form_msg("n24", n24,
                           "Adv only PV-tracer OFF, or called for LAM or ND")                           
