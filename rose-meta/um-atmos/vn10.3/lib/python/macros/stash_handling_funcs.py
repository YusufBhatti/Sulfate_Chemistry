...
IS_STASH_STREQ_NL = re.compile(r'namelist:streq\([0-9a-f]*\)')
IS_STASH_USAGE_NL = re.compile(r'namelist:use\([0-9a-f]*\)')
IS_STASH_DOMAIN_NL = re.compile(r'namelist:domain\([0-9a-f]*\)')
IS_STASH_TIME_NL = re.compile(r'namelist:time\([0-9a-f]*\)')
