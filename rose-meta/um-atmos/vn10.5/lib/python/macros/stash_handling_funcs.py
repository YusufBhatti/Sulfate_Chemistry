...
IS_STASH_STREQ_NL = re.compile(r'namelist:streq\(\d{5}_[0-9a-f]+\)')
IS_STASH_USAGE_NL = re.compile(r'namelist:use\([-.\w]+_[0-9a-f]+\)')
IS_STASH_DOMAIN_NL = re.compile(r'namelist:domain\([-.\w]+_[0-9a-f]+\)')
IS_STASH_TIME_NL = re.compile(r'namelist:time\([-.\w]+_[0-9a-f]+\)')
