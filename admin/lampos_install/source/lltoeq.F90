...
! Note that the following does not match UM code source
! UM code Scales longitude to range 0 to 360 degs
! Thus not possible to purely extract UM code source.
! using UM code breaks lampos.
