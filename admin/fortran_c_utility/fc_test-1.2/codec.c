...
/* This file belongs in section: admin                                        */
...
if (array1[0]==array1[1]) {
  ...
  if (array2[0]==array2[1]) {
    ...
    printf("Could not determine which C type"
           " is equivalent to Fortran REAL type");
    printf("FRL8=null\n");}
     }
...
/*  printf("C integer type \"int\" is 32 bits.\n"); */
  ...
  printf("Could not determine which C type"
         " is equivalent to Fortran INTEGER type");
...
last_val=*one_byte;
  ...
  if (first_val == 1) {
    ...
    printf("BIGEND=false\n");
    printf("LITTLE_END=true\n"); }
  else
    { if (last_val == 1) {
        printf("is Big Endian\n");
        printf("BIGEND=true\n");
        printf("LITTLE_END=false\n"); }
    else {
            printf("could not be determined\n");
            printf("BIGEND=null\n");
            printf("LITTLE_END=null\n"); }
    }
}
